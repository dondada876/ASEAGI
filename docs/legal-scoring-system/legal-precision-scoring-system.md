...
\* ;; ; ;
\* \* \disc\ \'01•; ; -360 \* \circle\ \'01◦; ; -360 ; 
 \* \disc\ \'01•; ; -360 ; 
 \* \disc\ \'01•; ; -360 ; 
 \* \disc\ \'01•; ; -360 ; 
 \* \disc\ \'01•; ; -360 ; 
 \* \decimal\ \'01\'00; \'01; -360 \* \circle\ \'01◦; ; -360 ; 
 \* \decimal\ \'01\'00; \'01; -360 ; 
 \* \disc\ \'01•; ; -360 ; 
\* 
...
** legal precision requires granular analysis
** . For impeachment, perjury prosecution, and judicial admissions, you need 
** statement-level truth tracking
** with 
...
tightenfactor0
 ...
 - TLS-050
 (Aggravated perjury - proven false by her own 2021 admission)\
...
- Mother's false ex parte statement: 
** ICS-920
** (Malevolent - she knew it was false, intended harm)\
...
- PAGE SCORE (PSS): 820/1000
 [High bad faith document]\
...
- AI processes documents
 →extracts all statements\

- AI scores each statement
 →7 dimensions per statement\

- AI aggregates to pages
 →page-level patterns\

- AI aggregates to documents
 →document credibility\

- AI aggregates to filings/party
 →overall patterns\
...
- High bad faith (BFQ ≥900)\
 ...
 Result:
 Legal precision with AI efficiency.\
